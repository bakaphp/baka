<?php  //[STAMP] 91f2b2c8ac8c4bcff2871be8e9d934bb
...
trait IntegrationTesterActions
{
     ...
     */
    public function grabFromDi($name) {
     ...
     *
     * @return array
     * @see \Helper\Integration::getModelRelationships()
     */
    public function getModelRelationships($class) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getModelRelationships', func_get_args()));
    }
     ...
     * @see \Helper\Integration::getRecordWithFields()
     */
    public function getRecordWithFields($modelName, $fields = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getRecordWithFields', func_get_args()));
    }
     ...
     * @see \Helper\Integration::haveConfig()
     */
    public function haveConfig($configData) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveConfig', func_get_args()));
    }
     ...
     * @param string $modelName
     * @param array  $fields
     * @see \Helper\Integration::haveModelDefinition()
     */
    public function haveModelDefinition($modelName, $fields) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveModelDefinition', func_get_args()));
    }
     ...
     *
     * @return mixed
     * @see \Helper\Integration::haveRecordWithFields()
     */
    public function haveRecordWithFields($modelName, $fields = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveRecordWithFields', func_get_args()));
    }
     ...
     */
    public function haveService($name, $service) {
     ...
     * @return mixed
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Integration::seeRecordFieldsValid()
     */
    public function canSeeRecordFieldsValid($modelName, $by, $except = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeRecordFieldsValid', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Integration::seeRecordFieldsValid()
     */
    public function seeRecordFieldsValid($modelName, $by, $except = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeRecordFieldsValid', func_get_args()));
    }
     ...
     * @param $fields
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Integration::seeRecordSaved()
     */
    public function canSeeRecordSaved($model, $by, $fields) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeRecordSaved', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeRecordSaved($model, $by, $fields) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeRecordSaved', func_get_args()));
    }
     ...
     * @see \Helper\Integration::getFileSystemEntity()
     */
    public function getFileSystemEntity() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getFileSystemEntity', func_get_args()));
    }
}
