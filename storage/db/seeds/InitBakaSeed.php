    ...
    public function run()
    {
        ...
        $data = [
            [
                ...
                'lastname' => 'Anonymouss',
                'default_company' => 1,
                'displayname' => 'anonymouss' . rand(1, 100),
                'system_modules_id' => 2,
            ...
            [
                ...
                'lastname' => $faker->lastName,
                'default_company' => 1,
                'displayname' => 'mcmnobodsy' . rand(1, 100),
                'system_modules_id' => 2,
                'user_level' => 3,
                'user_last_login_try' => 0,
                'created_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'lastname' => $faker->lastName,
                'default_company' => 1,
                'displayname' => 'mcmcmc3nose' . rand(1, 100),
                'system_modules_id' => 2,
                'user_level' => 2,
                'user_last_login_try' => 0,
                'created_at' => date('Y-m-d H:i:s'),
                ...
                'lastname' => $faker->lastName,
                'default_company' => 1,
                'displayname' => 'mcmcmcmc' . rand(1, 100),
                'system_modules_id' => 2,
                'user_level' => 1,
                'user_last_login_try' => 0,
                'created_at' => date('Y-m-d H:i:s'),
                ...
                'lastname' => $faker->lastName,
                'default_company' => 1,
                'displayname' => 'mcsomethingn' . rand(1, 100),
                'system_modules_id' => 2,
                'user_last_login_try' => 0,
                'user_level' => 1,
                'created_at' => date('Y-m-d H:i:s'),
