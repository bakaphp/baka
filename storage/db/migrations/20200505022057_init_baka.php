...
class InitBaka extends Phinx\Migration\AbstractMigration
{
    public function change()
    {
        ...
        $this->table('custom_fields', [
            ...
            ->addColumn('fields_type_id', 'integer', [
                'null' => false,
                'limit' => MysqlAdapter::INT_REGULAR,
        ...
        $this->table('custom_filters', [
            ...
            ->addColumn('sequence_logic', 'string', [
                'null' => false,
                'limit' => 64,
                'collation' => 'utf8mb4_unicode_ci',
                'encoding' => 'utf8mb4',
            ...
            ->addColumn('total_conditions', 'string', [
                'null' => false,
                'limit' => 64,
                'collation' => 'utf8mb4_unicode_ci',
                'encoding' => 'utf8mb4',
        ...
        $this->table('system_modules', [
            ...
            ->addColumn('browse_fields', 'string', [
                'null' => false,
                'limit' => 64,
                'collation' => 'utf8mb4_unicode_ci',
                'encoding' => 'utf8mb4',
